...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('This is your profile page. You can update your profile and change your password'),
        'class' => 'col-lg-7'
    ])   
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src="{{ asset('argon') }}/img/theme/person.jpg" class="rounded-circle">
                                </a>
                            </div>
                        </div>
                    </div>
